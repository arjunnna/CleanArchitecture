...
extension ImagesListViewController: DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
    ...
    func title(forEmptyDataSet scrollView: UIScrollView!) -> NSAttributedString! {
        ...
        let attributedString = NSAttributedString(string: title, attributes: [.font: UIFont.systemFont(ofSize: FontSize.large.value),
    ...
    func description(forEmptyDataSet scrollView: UIScrollView!) -> NSAttributedString! {
        ...
        let attributedString = NSAttributedString(string: description, attributes: [.font: UIFont.systemFont(ofSize: FontSize.medium.value),
                                                                                    .foregroundColor: UIColor.lightGray
        ])
        return attributedString
    }
    ...
    func buttonTitle(forEmptyDataSet scrollView: UIScrollView!, for state: UIControl.State) -> NSAttributedString! {
        let attributedString = NSAttributedString(string: "Try Again", attributes: [.font: UIFont.systemFont(ofSize: FontSize.medium.value),
